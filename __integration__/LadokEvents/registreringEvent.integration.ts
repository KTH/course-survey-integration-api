import event from "../../__tests__/LadokEvents/fixtures/events/01_studiedeltagande.RegistreringEvent_1.json";
...
import studentParticipation_01 from "../../__tests__/LadokEvents/fixtures/entities/01_studentParticipation.json";
